...
class SampleTrainAndTest(sl.SlurmTask):
    ...
    def out_traindata(self):
        return sl.TargetInfo(self, self.get_basepath() + '_train')
    def out_testdata(self):
        return sl.TargetInfo(self, self.get_basepath() + '_test')
    def out_log(self):
        return sl.TargetInfo(self, self.get_basepath() + '_train.log') # This is generated by the jar
